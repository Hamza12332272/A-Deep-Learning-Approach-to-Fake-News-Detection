...
def get_dataset():
    """
    Download or locate the dataset dynamically.
    """
    try:
        import kagglehub
        ...
        # Fallback to local dataset if kagglehub is not available
...
if __name__ == "__main__":
    ...
    model, X_test, y_test = train_model(model, dataset, max_sequence_length=500, epochs=3)
